...
void modifyRobotByValue(Robot r) { r.setBatteryLife(80); };

// Step 3: Function to modify robot (pass by reference)

void modifyRobotByRef(Robot *r) { r->setBatteryLife(80); };
...
int main() {
  ...
  Robot myRobot("My Robot", "AnthropicBot", 100);

  // Step 6: Use pointers to access Robot object

  Robot *robotPtr = &myRobot;

  robotPtr->setBatteryLife(90);
  ...
  modifyRobotByRef(robotPtr);

  cout << "After modifyRobotByReference, Battery Life: "
       << myRobot.getBatteryLife() << "%\n";
